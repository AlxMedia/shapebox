		...
		<div id="footer-bottom">
			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="credit">
						<p><?php esc_html_e('Powered by','shapebox'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'shapebox' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','shapebox'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
